...
- [ ] T07 Gate 1 brief for Codex | verify: `./scripts/check-reviews.sh` | done when: reviews/gate-1-review.md verdict implementation-ready AND the brief states gate 1 is locally implementation-ready, not deploy-ready (the init_price_feed oracle-takeover block in OPEN-QUESTIONS stands until T23)
